 ...
 */
public class TripsListResponseSerializer extends ResponseSerializer {

    private List<Trip> result;

    public TripsListResponseSerializer() {
    }

    public TripsListResponseSerializer(ResponseStatus status, List<ErrorMessages> errorMessage, List<Trip> result) {
